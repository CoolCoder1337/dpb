...
async def http(ctx):
    ...
    f.truncate(0)
    r = requests.get('https://api.proxyscrape.com/?request=displayproxies&proxytype=http&timeout=5000', 'https://proxy11.com/api/proxy.txt?key=MzMzNg.YJueEw.VIcWtYsNcROjL9NAdgjVUVXDYjU')
    proxies = []
...
async def https(ctx):
    ...
    f.truncate(0)
    r = requests.get('https://api.proxyscrape.com/?request=displayproxies&proxytype=https&timeout=5000', 'https://proxy11.com/api/proxy.txt?key=MzMzNg.YJueEw.VIcWtYsNcROjL9NAdgjVUVXDYjU')
    proxies = []
    for proxy in r.text.split('\n'):
        proxy = proxy.strip()
        if proxy:
...
async def socks4(ctx):
    ...
    f.truncate(0)
    r = requests.get('https://api.proxyscrape.com/?request=displayproxies&proxytype=socks4&timeout=5000', 'https://proxy11.com/api/proxy.txt?key=MzMzNg.YJueEw.VIcWtYsNcROjL9NAdgjVUVXDYjU')
    proxies = []
    for proxy in r.text.split('\n'):
        proxy = proxy.strip()
        if proxy:
...
async def socks5(ctx):
    ...
    f.truncate(0)
    r = requests.get('https://api.proxyscrape.com/?request=displayproxies&proxytype=socks5&timeout=5000', 'https://proxy11.com/api/proxy.txt?key=MzMzNg.YJueEw.VIcWtYsNcROjL9NAdgjVUVXDYjU')
    proxies = []
    for proxy in r.text.split('\n'):
        proxy = proxy.strip()
        if proxy:
...
async def all(ctx):
    ...
    f.truncate(0)
    r = requests.get('https://api.proxyscrape.com/?request=displayproxies&proxytype=all&timeout=5000', 'https://proxy11.com/api/proxy.txt?key=MzMzNg.YJueEw.VIcWtYsNcROjL9NAdgjVUVXDYjU')
    proxies = []
    for proxy in r.text.split('\n'):
        proxy = proxy.strip()
        if proxy:
